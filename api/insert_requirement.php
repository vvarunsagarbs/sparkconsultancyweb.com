  ...
  if($_GET['ip'] && $_GET['person'] && $_GET['companyName'] && $_GET['email'] && $_GET['city'] && $_GET['phone'] && $_GET['enquiry'] && $_GET['address'] && $_GET['sector']) {
    ...
    if ($query->execute()) {
      ...
      // Send mail
        ...
        $email_admin_body .= "<table style='text-align:left;'><tr><th> <strong> Contact Name </strong> </th><td>".$person."</td></tr>";
        ...
        $email_admin_body .= "<tr><th> <strong> Sector </strong> </th><td>".$sector."</td></tr>";
